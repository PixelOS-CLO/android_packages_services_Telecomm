...
// QTI_END: 2023-04-13: Telephony: Revert "Ensure to start dialer process with persistent priority"
    ...
    public void onCallStateChanged(Call call, int oldState, int newState) {
        ...
        if ((oldState == CallState.RINGING || oldState == CallState.DIALING)
            ...
            boolean vibrateOnConnect = Settings.System.getInt(
                    mContext.createContextAsUser(call.getAssociatedUser(), 0).getContentResolver(),
            ...
            boolean vibrateOnDisconnect = Settings.System.getInt(
                    mContext.createContextAsUser(call.getAssociatedUser(), 0).getContentResolver(),
